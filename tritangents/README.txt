...
numerical homotopy, refine solutions using `refine.jl`, save output to
`sols_refined.out`.  Complete run logged in `homotopy.log`.

Step 2: run `regex-m-jl.py` to convert to magma, output `sols_refined.m`.
